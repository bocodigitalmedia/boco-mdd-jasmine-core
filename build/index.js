...
configure = function($) {
  ...
  Snippets = (function() {
    ...
    Snippets.prototype.addInitializeVariables = function(arg) {
      var depth, variableNames;
      variableNames = arg.variableNames, depth = arg.depth;
      return this.add({
    ...
    Snippets.prototype.toArray = function() {
  ...
  SnippetsRenderer = (function() {
    ...
    SnippetsRenderer.prototype.renderSnippet = function(renderedSnippets, snippet) {
      ...
      if (renderFn == null) {
        throw Error(renderFnName + " not defined");
      }
      snippetStr = renderFn.call(this, snippet);
      if (snippetStr == null) {
        return renderedSnippets;
      }
      renderedSnippet = this.indent(snippetStr, snippet.depth);
      renderedSnippets.push(renderedSnippet);
      return renderedSnippets;
    };

    SnippetsRenderer.prototype.render = function(snippets) {
      var renderedSnippets;
      renderedSnippets = snippets.toArray().reduce(this.renderSnippet.bind(this), []);
      return renderedSnippets.join(this.joinString) + "\n";
    };
